...
*Feel free write me  <a href="https://github.com/bbk14/TermuxDebian/issues" target="_blank">GitHub</a> to add some packages if you want, if it possible I add this in future updates. You can install it without reinstall<br>
